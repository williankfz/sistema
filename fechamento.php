<?php
include('con_bd.php');
$pesquisa = mysqli_query($con,"SELECT*FROM recebe2 ORDER BY produto2 ASC");
?>
<html>
<head>
    <meta charset="utf-8">

<title>Relátorio de fechamento de caixa</title>
...
<div id="fim2">
<br>
<form method="post" action="fechamento2.php">
