...
$u = mysqli_query($con,"SELECT*FROM funcionario WHERE id='$id2'");
...
<form name="form1" action="excluir2.php?n1=<?php echo $id ?>&n2=1" method="post">
 <h1>Alterar funcionários</h1><br>


<div class="formatacao">Nome Do Funcionário:</div>   
